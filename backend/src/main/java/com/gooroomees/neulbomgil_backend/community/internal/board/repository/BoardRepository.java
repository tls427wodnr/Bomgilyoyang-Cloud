...
public interface BoardRepository extends JpaRepository<Board, Long> {
    ...
    @Query(value = "SELECT b FROM Board b ORDER BY b.cnt DESC",
            countQuery = "SELECT COUNT(b) FROM Board b")
    ...
    @Query(value = "SELECT b FROM Board b WHERE b.title LIKE %:keyword% OR b.content LIKE %:keyword% ORDER BY b.createdAt DESC",
